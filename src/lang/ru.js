const ru = {
	...
	MainCategories: {
		...
		cards: [
			{link: "/buy", img: "buy", title: "Buy", text: "С нами Вы легко сможете найти самые актуальные предложения по покупке недвижимости.", button: "123"},
			{link: "/rent", img: "rent", title: "Rent", text: "В нашем сервисе Вы в кратчайший срок сможете найти подходящую недвижимость для аренды.", button: "123"},
			{link: "/sell", img: "sell", title: "Sell", text: "- Пользователи нашей платформу в три раза чаще сдают недвижимость.", button: "123"}
		]
	},
	MainFilters: {
